...
public class MechanicalChestplate extends ArmorManager {
    public MechanicalChestplate() {
        super(Material.CHAINMAIL_CHESTPLATE, Color.BLACK , Trim.COPPER, Pattern.SENTRY,"Mechanical Chestplate", Ability.MECHANICAL_SHOT, Tier.MECHANICAL,4,4,2,1, EquipmentSlot.CHEST,false);
    }
}
