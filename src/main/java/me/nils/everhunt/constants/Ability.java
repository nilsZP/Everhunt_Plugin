...
public enum Ability {
    ...
    SUMMON("Summon",0,10,Activation.DROP,40,true,20,"&7Reincarnates the soul and makes it attack the monster you're looking at.","&7Target must less than 6 blocks away."),
